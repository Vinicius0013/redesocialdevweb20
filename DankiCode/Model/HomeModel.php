    ...
    class HomeModel
    {
        ...
        public static function retrieveFriendsPosts()
        {
            ...
            foreach($amigosConfirmados as $key => $value) {
                $listaAmigos[$key]['id'] = \DankiCode\Model\UsuariosModel::getUsuarioById($value)['id'];
                $listaAmigos[$key]['nome'] = \DankiCode\Model\UsuariosModel::getUsuarioById($value)['nome'];
                $listaAmigos[$key]['email'] = \DankiCode\Model\UsuariosModel::getUsuarioById($value)['email'];
                $listaAmigos[$key]['img'] = \DankiCode\Model\UsuariosModel::getUsuarioById($value)['img'];
                $listaAmigos[$key]['ultimo_post'] = \DankiCode\Model\UsuariosModel::getUsuarioById($value)['ultimo_post'];
            }
            ...
            foreach($listaAmigos as $key => $value) {
                ...
                if ($ultimoPost->rowCount() >= 1) {
                    ...
                    $posts[$key]['data'] = $value['ultimo_post'];
